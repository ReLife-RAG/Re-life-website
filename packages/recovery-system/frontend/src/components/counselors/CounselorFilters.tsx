...
import { FilterState, SpecializationFilter, AvailabilityFilter } from "./types";
  ...
  return (
    <aside className="w-56 shrink-0">
      ...
      <div className="flex items-center justify-between mb-5">
        ...
        <button onClick={resetFilters} className="text-xs text-[#4caf7d] font-medium hover:underline">
          RESET
        </button>
      </div>
